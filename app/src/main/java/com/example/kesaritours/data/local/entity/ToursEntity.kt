...
data class ToursEntity(
    ...
    @ColumnInfo(name = "tm_days") var tmDays: Int? = null,
    ...
    @ColumnInfo(name = "generated_cost_2_day") var generatedCost2Day: Int? = null,
    @ColumnInfo(name = "start_city") var startCity: String? = null,
    @ColumnInfo(name = "end_city") var endCity: String? = null,
    @ColumnInfo(name = "total_city") var totalCity: Int? = null,
    @ColumnInfo(name = "journey_category") var journeyCategory: String? = null,
    @ColumnInfo(name = "generated_disc_2_day") var generatedDisc2Day: Int? = null,
    @ColumnInfo(name = "generated_net_cost") var generatedNetCost: Int? = null,
